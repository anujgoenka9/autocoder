...
import { SquareCodeIcon, Home, LogOut, FolderOpen } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  ...
  if (!user) {
    return (
      <>
        ...
        <Button asChild className="rounded-full bg-gradient-primary hover:opacity-90 text-white">
    ...
    <header className="border-b border-border bg-card">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        <Link href="/" className="flex items-center">
          ...
          <span className="ml-2 text-xl font-semibold text-ai-primary">AutoCoder</span>
        </Link>
        <div className="flex items-center space-x-4">
          <Link
            href="https://github.com/anujgoenka9/autocoder"
            target="_blank"
